...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        # parser.set_defaults(dataroot='C:\\Users\\mwrd\\Desktop\\old\\eyelid_gland_data')
        parser.add_argument('--display_freq', type=int, default=400,
                            help='frequency of showing training results on screen')
        parser.add_argument('--display_ncols', type=int, default=4,
                            help='if positive, display all images in'
                                 ' a single visdom web panel with certain number of images per row.')
        ...
        parser.add_argument('--n_epochs_decay', type=int, default=151,
                            help='number of epochs to linearly decay learning rate to zero')
        parser.add_argument('--beta1', type=float, default=0.5, help='momentum term of adam')
        parser.add_argument('--lr', type=float, default=0.0001, help='initial learning rate for adam')
        parser.add_argument('--weight_decay', type=float, default=0.005, help='initial weight decay for adam')
